...
public class DTTextField: UITextField {
    ...
    public var borderColor:UIColor = Constant.GlobalConstants.kColor_Theme{
    ...
    fileprivate func commonInit() {
        ...
        floatPlaceholderColor       = Constant.GlobalConstants.kColor_Theme
        floatPlaceholderActiveColor = Constant.GlobalConstants.kColor_Theme
