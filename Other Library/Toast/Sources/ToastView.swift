...
open class ToastView: UIView {
  ...
  private let textLabel: UILabel = {
    ...
    self.font = {
      ...
      case .phone: return .systemFont(ofSize: 15)
      case .pad: return .systemFont(ofSize: 20)
      case .tv: return .systemFont(ofSize: 25)
      case .carPlay: return .systemFont(ofSize: 14)
      }
    }()
  ...
  override open func layoutSubviews() {
    ...
    let constraintSize = CGSize(
      width: containerSize.width * (300.0 / 320.0),
    ...
    self.textLabel.frame = CGRect(
      ...
      height: textLabelSize.height+30
    )
